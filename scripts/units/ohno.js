...
const unitSpawn1 = new UnitSpawnAbility(spawnUnit3, 15 * 20, 0, 0);
...
ohno.abilities.add(new UnitSpawnAbility(spawnUnit2, 5 * 20, 18, 7));
ohno.abilities.add(new UnitSpawnAbility(spawnUnit2, 5 * 20, -18, 7));
ohno.abilities.add(new UnitSpawnAbility(spawnUnit, 7 * 20, 18, -7));
ohno.abilities.add(new UnitSpawnAbility(spawnUnit, 7 * 20, -18, -7));
ohno.abilities.add(new UnitSpawnAbility(spawnUnit3, 10 * 20, 0, 0));
